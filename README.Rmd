...
Based on this calculation, our projection for this set of scenarios is that we would expect around `r round(sum(unadj_counts * adjustment_rates))` hyper-heatwaves in the 82 study communities for 2061--2080. 
...
For this combination of ensemble member, emission scenario, and population scenario, our estimated projection of exposure to hyper-heatwaves is `r round(sum(exp_projs$exposure * adjustment_rates) / 10^6 / 20)` million person-days per year across the 82 study communities.
